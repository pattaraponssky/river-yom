...
const ManualUpdateRain: React.FC = () => {
  ...
  const handleUpdate = async () => {
    ...
    // 3. Construct API URL for Rain Data
    // This is the key change from ManualUpdateReservoir
    const apiUrl = `${API_URL}/jobs/updateRainFillData/${formattedStartDate}/${formattedEndDate}`;
    ...
    try {
      ...
      console.error("Error updating rain data:", error);
...
export default ManualUpdateRain;