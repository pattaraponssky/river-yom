...
const ManualUpdateFlow: React.FC = () => {
  ...
  const handleUpdate = async () => {
    ...
    // 3. Construct API URL for Flow Data
    // This is the key change from ManualUpdateReservoir
    const apiUrl = `${API_URL}/jobs/updateFlowFillData/${formattedStartDate}/${formattedEndDate}`;
  ...
  return (
    <Box sx={{ fontFamily: "'Prompt', sans-serif", mt: {md:4,xs:2} }}>
      <Typography variant="h5" sx={{ marginBottom: "1rem", fontWeight: 600, ...titleStyle, color: "#28378B" }}>
        อัปเดตข้อมูลน้ำท่า (กำหนดวันที่)
      </Typography>
...
export default ManualUpdateFlow;