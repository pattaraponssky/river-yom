...
const InfoTeleStation: React.FC = () => {
  ...
  return (
    <>
      <StationTable
        stations={stations}
        title="เพิ่มสถานีติดตั้งโครงการ"
        addLabel="เพิ่มสถานี"
        idField="sta_code"
...
export default InfoTeleStation;