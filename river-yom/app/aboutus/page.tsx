    ...
    <Container maxWidth="lg" sx={{ py: { xs: 4, md: 8 } }}>
      ...
      >
        ...
        <Box component="ol" sx={{ pl: 4, mb: 3 }}>
          {[
            "สะพานชุมแสงสงคราม ต.ชุมแสงสงคราม (แม่น้ำยม ท้าย ปตร.วังสะตือ)",
            "สะพานบ้านห้วงกระได ต.บางระกำ (คลองหนองเหล็ก)",
            "สะพานวัดทุ่งอ้ายโห้ ต.ชุมแสงสงคราม (คลองกลุกกลัก)",
            "สะพานข้ามคลองกรุงกรัก (บ้านยางแขวนอู่) ต.บางระกำ",
            "สะพานท่านางงาม ต.ท่านางงาม (แม่น้ำยม ก่อน ปตร.ท่านางงาม)",
            "สะพานข้ามคลองคด (ถนนพิษณุโลก-นครสวรรค์) ต.บ่อทอง",
          ].map((item, index) => (
            <Typography
              key={index}
              component="li"
        ...
        <Box component="ol" sx={{ pl: 4, mb: 3 }}>
          <Typography component="li" variant="body1" sx={{ ...textStyle, mb: 1.5, fontWeight: "bold" }}>
            งานศึกษาและพัฒนาระบบตรวจวัด เพื่อการติดตามและบริหารจัดการน้ำ
          </Typography>
          <Typography component="li" variant="body1" sx={{ ...textStyle, mb: 1.5, fontWeight: "bold" }}>
            งานศึกษาและออกแบบระบบในการช่วยสนับสนุนการตัดสินใจในการบริหารจัดการน้ำ
          </Typography>
          <Typography component="li" variant="body1" sx={{ ...textStyle, fontWeight: "bold" }}>
            งานพัฒนาและออกแบบระบบฐานข้อมูล รวมถึงโปรแกรมประยุกต์สำหรับแสดงผลข้อมูลสถานการณ์น้ำ (Dashboard แบบ Web-based )
          </Typography>
        </Box>
